...
interface NumericKeyboardModalDecimalProps {
  isOpen: boolean
  value: number
  onClose: () => void
...
export default function NumericKeyboardModalDecimal({
  isOpen,
  value,
  onClose,
  onConfirm,
  ...
  maxValue = 9999,
  allowDecimals = true,
}: NumericKeyboardModalDecimalProps) {
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          ...
          <button
            ...
            className={`font-bold py-3 rounded-lg text-xl transition-colors ${
              allowDecimals
                ? 'bg-secondary-100 hover:bg-secondary-200 text-secondary-900 cursor-pointer'
